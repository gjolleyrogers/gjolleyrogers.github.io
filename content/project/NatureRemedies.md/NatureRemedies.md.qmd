...
subject: workflow
lang: en
date: 2024-02-16      # Scrivener placeholder
...
<span class="sidenote">Here is some marginalia using the [`Marginalia`] Paragraph Style, *including* a citation [@barrett2015]. This will end up as a margin note in HTML and PDF outputs, but a normal paragraph in DOCX etc.</span>
...
<span class="sidenote">![A figure of a poor, poor marginalised elephant…](Elephant3.jpg){#fig-marginalia}</span>
