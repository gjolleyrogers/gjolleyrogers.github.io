...
//  Tree and Characters 
            ...
            var tmpl = st.config.tmpl, nodeList = [], node,  split, SpatialPortal;
              ...
              var html = '', names = [], formattedNames = [], output = [], header = ['   ',' ',' ',' ', ' ', ' '], temp, link;
              ...
              output.push ( header );
                ...
                SpatialPortal = '<a  class="thumbImage1" title="ALA Spatial Portal" href="http://spatial.ala.org.au/?';
			...
			SpatialPortal = SpatialPortal + '"> Spatial Portal</a> for 1st 15';
       
                return "Clade " +  SpatialPortal + '<table>'+result+'</table>' ;
                
            }, //presentClade 
        
           onPresentClade:function ( ) {
                 		  $('.thumbImage1').colorbox({iframe:true,width:'100%',height:'70%'});
           			},  // onPresentClade
